...
ifeq ($(BUILD_OUT_OF_SOURCE),YES)
  ...
  ifneq ($(SRC_DIRS),)
    SRCVPATH += $(addprefix $(PATH_TO_COMPONENT)/, $(SRC_DIRS))
  else
    SRCVPATH += $(PATH_TO_COMPONENT)
  endif
else
  SRCVPATH += $(SRC_DIRS)
endif
...
SRCVPATH += $(ABS_SRC_DIRS)

# use vpath only for these files
vpath %.c $(SRCVPATH)
vpath %.f $(SRCVPATH)
vpath %.F90 $(SRCVPATH)
vpath %.m4F90 $(SRCVPATH)
vpath %.m4f $(SRCVPATH)
...
$(DEPENDFILE): $(FFSRCS) $(CSRCS) .current_options .current_srcs $(RUN_H)
	...
	$(FMAKEDEP) $(CPPFLAGS) $(addprefix -I,$(SRCVPATH)) -f $(DEPENDFILE)_tmp $(FFSRCS_CPP)
...
clean:
	...
	.current_srcs rundeck_opts.h *.cpp *.bin $(CLEAN_LIST)
