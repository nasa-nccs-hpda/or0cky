module apex
! August, 2020: Greg Faluvegi at NASA GISS is using the code in this file
! (almost!) without modification, attempting to integrate it for use with
! GISS modelE. Adding comment:
...
! tiegcmlicense.txt."
! I had to make a change: to make ggrid routine public. So, since I was
! doing that anyway, I also made masterproc references to the function
! (thus added () parentheses when referencing it. That is all.)
!
