...
c
      arr(next()) = info_type_(
     &  sname = 'BA_grass',
     &  lname = 'Grass Burned Area FOR DYN BIOBURN',
     &  units = 'm2'
     &     )
c
      arr(next()) = info_type_(
     &  sname = 'BA_shrub',
     &  lname = 'Shrub Burned Area FOR DYN BIOBURN',
     &  units = 'm2'
     &     )
c
      arr(next()) = info_type_(
     &  sname = 'BA_tree',
     &  lname = 'Tree Burned Area FOR DYN BIOBURN',
     &  units = 'm2'
     &     )
c
      arr(next()) = info_type_(
...
c
      arr(next()) = info_type_(
     &  sname = 'evaplsm',
     &  lname = 'Evaporation from LSM fraction',
     &  units = 'mm/day',
     &  scale = real(nday,kind=8),
     &  dname = 'frlsm'
     &     )
