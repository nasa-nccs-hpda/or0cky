...
module constant
   ...
   use MathematicalConstants_mod, only: RADIANS_PER_DEGREE
...
!@param k_boltzmann Boltzmann's constant [J K-1]
  real*8,parameter :: k_boltzmann = 1.380662d-23

!@param h_planck Planck constant [J s]
  real*8,parameter :: h_planck = 6.626176d-34

!@param c_light  Speed of light in a vacuum [m s-1]
  real*8,parameter :: c_light = 2.9979245d+08
...
!@param fraction of N2 in dry air (0-1)
      real*8,parameter :: pN2 = exoPlanetParams%pN2
!@param fraction of O2 in dry air (0-1)
      real*8,parameter :: pO2 = exoPlanetParams%pO2
!@param fraction of Ar in dry air (0-1)
      real*8,parameter :: pAr = exoPlanetParams%pAr
!@param fraction of H2 in dry air (0-1)
      real*8,parameter :: pH2 = exoPlanetParams%pH2
#else
!@param fraction of N2 in dry air (0-1)
...
!@param fraction of Ar in dry air (0-1)
      real*8,parameter :: pAr = 0.0093d0
!@param fraction of H2 in dry air (0-1)
      real*8,parameter :: pH2 = 0.0d0
#endif
...
!@param astronomical_unit Standard Astronomical Unit [m]
  real*8,parameter :: astronomical_unit = 149597870700.0D+00
!@param solar_t_effective Effective solar temperature [K]
  real*8,parameter :: solar_t_effective = 5.785D+03
!@param solar_radius Radius of the Sun [m]
  real*8,parameter :: solar_radius = 6.96D+08
