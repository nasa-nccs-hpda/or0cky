...
!@auth Jan Perlwitz, Reha Cakmur, Ina Tegen
    ...
    (defined TRACERS_AMP) || (defined TRACERS_TOMAS)
      ...
      use trdust_mod, only : wsubtke_dust_on, wsubwd_dust_on,
     &     wsubwm_dust_on
...
c optionally switch off subgrid scale contributions to dust emission
      if ( wsubtke_dust_on == 0 ) wsubtke = 0.d0
      if ( wsubwd_dust_on == 0 ) wsubwd = 0.d0
      if ( wsubwm_dust_on == 0 ) wsubwm = 0.d0
...
c**** input
     ...
     &     pbl_args%d_dust( : )
      ...
      snowfr=pbl_args%snowfr
      rhosrf=pbl_args%rhosrf
