...
! Arrays to store cloud properties for planet radiation (SOCRATES). The layer
! ordering is here as in CLOUDS with the bottom most layer indexed as 1.
! The number of layers in these arrays is equal to the number of layers in
! CLOUDS, i.e. number of dynamical levels. Radiation may have additional levels
! at the top not included in these arrays.
  REAL*8, ALLOCATABLE :: &
      w_cloud(:,:,:) &
...
!@dbparam cld_plow low-level clouds in layers with mid-pt pressures >= cld_plow (mb)
!@dbparam cld_pmid mid-level clouds in layers with mid-pt pressures >= cld_pmid (mb)
  real*8 :: cld_plow,cld_pmid
...
#ifdef USE_PLANET_RAD
  ALLOCATE( &
      w_cloud(LM,I_0H:I_1H,J_0H:J_1H) &
    , frac_st_water(LM,I_0H:I_1H,J_0H:J_1H) &
    , frac_st_ice(LM,I_0H:I_1H,J_0H:J_1H) &
    , frac_cnv_water(LM,I_0H:I_1H,J_0H:J_1H) &
    , frac_cnv_ice(LM,I_0H:I_1H,J_0H:J_1H) &
    , mix_ratio_st_water(LM,I_0H:I_1H,J_0H:J_1H) &
    , mix_ratio_st_ice(LM,I_0H:I_1H,J_0H:J_1H) &
    , mix_ratio_cnv_water(LM,I_0H:I_1H,J_0H:J_1H) &
    , mix_ratio_cnv_ice(LM,I_0H:I_1H,J_0H:J_1H) &
    , dim_char_st_water(LM,I_0H:I_1H,J_0H:J_1H) &
    , dim_char_st_ice(LM,I_0H:I_1H,J_0H:J_1H) &
    , dim_char_cnv_water(LM,I_0H:I_1H,J_0H:J_1H) &
    , dim_char_cnv_ice(LM,I_0H:I_1H,J_0H:J_1H) &
    , frac_area_st(LM,I_0H:I_1H,J_0H:J_1H) &
    , frac_area_cnv(LM,I_0H:I_1H,J_0H:J_1H))
#endif
#ifdef AIE_DIAG_FIX_MET
