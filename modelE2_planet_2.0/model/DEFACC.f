...
c
     ...
     &       'float '//trim(sname)//'_hemis(shnhgm) ;')
      ...
      USE planet_rad, ONLY: n_band_lw, n_band_sw
#endif
      implicit none
...
c
      ...
      allocate(index1(kaij),name3(kaij),dim3name(kaij))
#if defined(USE_PLANET_RAD) && defined(GISS_RAD_OFF)
      allocate(coord3(MAX(100, MAX(n_band_lw, n_band_sw)), kaij))
#else
      allocate(coord3(100, kaij))
#endif
...
c
      k=k+1 !
      IJ_PLAND = k ! not accumulated
      lname_ij(k) = 'LAND FRACTION, incl. LAKES, LAND ICE'
      units_ij(k) = '%'
      name_ij(k) = 'landfr'
      ia_ij(k) = ia_src
      scale_ij(k) = 100.
...
c
      ...
      IJ_GBSIF = k
      name_ij(k) = 'bs_iflay1' !
      lname_ij(k) = 'BARE SOIL LAYER 1 ICE FRACTION'
      units_ij(k) = '1'
      ia_ij(k) = ia_srf
      scale_ij(k) = 1.
      ir_ij(k) = ir_m80_28
...
c
      k=k+1
      name_ij(k) = 'bs_iflay2' !
      lname_ij(k) = 'BARE SOIL LAYER 2 ICE FRACTION'
      units_ij(k) = '1'
      ia_ij(k) = ia_srf
      scale_ij(k) = 1.
      ir_ij(k) = ir_m80_28
...
c
      k=k+1
      name_ij(k) = 'bs_iflay3' !
      lname_ij(k) = 'BARE SOIL LAYER 3 ICE FRACTION'
      units_ij(k) = '1'
      ia_ij(k) = ia_srf
      scale_ij(k) = 1.
      ir_ij(k) = ir_m80_28
...
c
      k=k+1
      name_ij(k) = 'bs_iflay4' !
      lname_ij(k) = 'BARE SOIL LAYER 4 ICE FRACTION'
      units_ij(k) = '1'
      ia_ij(k) = ia_srf
      scale_ij(k) = 1.
      ir_ij(k) = ir_m80_28
...
c
      k=k+1
      name_ij(k) = 'bs_iflay5' !
      lname_ij(k) = 'BARE SOIL LAYER 5 ICE FRACTION'
      units_ij(k) = '1'
      ia_ij(k) = ia_srf
      scale_ij(k) = 1.
      ir_ij(k) = ir_m80_28
...
c
      k=k+1
      name_ij(k) = 'bs_iflay6' !
      lname_ij(k) = 'BARE SOIL LAYER 6 ICE FRACTION'
      units_ij(k) = '1'
      ia_ij(k) = ia_srf
      scale_ij(k) = 1.
      ir_ij(k) = ir_m80_28
...
c
      k=k+1
      IJ_GVSIF = k
      name_ij(k) = 'can_ice_fr' !
      lname_ij(k) = 'CANOPY ICE FRACTION'
      units_ij(k) = '1'
      ia_ij(k) = ia_srf
      scale_ij(k) = 1.
      ir_ij(k) = ir_m80_28
...
c
      k=k+1
      name_ij(k) = 'vs_iflay1' !
      lname_ij(k) = 'VEGETATED SOIL LAYER 1 ICE FRACTION'
      units_ij(k) = '1'
      ia_ij(k) = ia_srf
      scale_ij(k) = 1.
      ir_ij(k) = ir_m80_28
...
c
      k=k+1
      name_ij(k) = 'vs_iflay2' !
      lname_ij(k) = 'VEGETATED SOIL LAYER 2 ICE FRACTION'
      units_ij(k) = '1'
      ia_ij(k) = ia_srf
      scale_ij(k) = 1.
      ir_ij(k) = ir_m80_28
...
c
      k=k+1
      name_ij(k) = 'vs_iflay3' !
      lname_ij(k) = 'VEGETATED SOIL LAYER 3 ICE FRACTION'
      units_ij(k) = '1'
      ia_ij(k) = ia_srf
      scale_ij(k) = 1.
      ir_ij(k) = ir_m80_28
...
c
      k=k+1
      name_ij(k) = 'vs_iflay4' !
      lname_ij(k) = 'VEGETATED SOIL LAYER 4 ICE FRACTION'
      units_ij(k) = '1'
      ia_ij(k) = ia_srf
      scale_ij(k) = 1.
      ir_ij(k) = ir_m80_28
...
c
      k=k+1
      name_ij(k) = 'vs_iflay5' !
      lname_ij(k) = 'VEGETATED SOIL LAYER 5 ICE FRACTION'
      units_ij(k) = '1'
      ia_ij(k) = ia_srf
      scale_ij(k) = 1.
      ir_ij(k) = ir_m80_28
...
c
      k=k+1
      name_ij(k) = 'vs_iflay6' !
      lname_ij(k) = 'VEGETATED SOIL LAYER 6 ICE FRACTION'
      units_ij(k) = '1'
      ia_ij(k) = ia_srf
      scale_ij(k) = 1.
      ir_ij(k) = ir_m80_28
...
c
      k=k+1 !
      IJ_CLDW = k ! STRATIFORM CLOUD LIQUID+ICE WATER PATH, omits precip
      lname_ij(k) = 'STRATIFORM CLOUD LIQUID+ICE WATER PATH'
      units_ij(k) = 'kg/m^2'
      name_ij(k) = 'cldw'
      ia_ij(k) = ia_src
      scale_ij(k) = 1.
c
      k=k+1 !
      IJ_CLDI = k ! STRATIFORM CLOUD ICE PATH, omits precip
      lname_ij(k) = 'STRATIFORM CLOUD ICE WATER PATH'
      units_ij(k) = 'kg/m^2'
      name_ij(k) = 'cldi'
      ia_ij(k) = ia_src
      scale_ij(k) = 1.
c
      k=k+1
      IJ_LWPrad = k ! LIQUID WATER PATH SEEN BY RADIATION (kg/m**2), conv+strat, includes in-cloud precip
...
c
      k=k+1
      IJ_IWPrad = k ! ICE WATER PATH SEEN BY RADIATION (kg/m**2), conv+strat, includes in-cloud precip
...
c
      k=k+1
      IJ_WLAY1 = k
      lname_ij(k) = 'LAYER 1 SOIL WATER UNDER LAKES'
      units_ij(k) = 'kg/m2'
      name_ij(k) = 'lk_wlay1'
      ia_ij(k) = ia_src
      scale_ij(k) = 1.
...
c
      k=k+1
      lname_ij(k) = 'LAYER 2 SOIL WATER UNDER LAKES'
      units_ij(k) = 'kg/m2'
      name_ij(k) = 'lk_wlay2'
      ia_ij(k) = ia_src
      scale_ij(k) = 1.
...
c
      k=k+1
      lname_ij(k) = 'LAYER 3 SOIL WATER UNDER LAKES'
      units_ij(k) = 'kg/m2'
      name_ij(k) = 'lk_wlay3'
      ia_ij(k) = ia_src
      scale_ij(k) = 1.
...
c
      k=k+1
      lname_ij(k) = 'LAYER 4 SOIL WATER UNDER LAKES'
      units_ij(k) = 'kg/m2'
      name_ij(k) = 'lk_wlay4'
      ia_ij(k) = ia_src
      scale_ij(k) = 1.
...
c
      k=k+1
      lname_ij(k) = 'LAYER 5 SOIL WATER UNDER LAKES'
      units_ij(k) = 'kg/m2'
      name_ij(k) = 'lk_wlay5'
      ia_ij(k) = ia_src
      scale_ij(k) = 1.
...
c
      k=k+1
      lname_ij(k) = 'LAYER 6 SOIL WATER UNDER LAKES'
      units_ij(k) = 'kg/m2'
      name_ij(k) = 'lk_wlay6'
      ia_ij(k) = ia_src
      scale_ij(k) = 1.
...
c
      k=k+1
      IJ_MWL = k
      lname_ij(k) = 'MASS OF LAKE AND RIVER WATER/grid cell area'
      units_ij(k) = 'kg/m2'
      name_ij(k) = 'mwl'
      ia_ij(k) = ia_src
      scale_ij(k) = 1.
...
c
      k=k+1
      ij_tlake1 = k 
      lname_ij(k) = 'First Layer Lake Temperature'
      units_ij(k) = 'C'
      name_ij(k)  = 'tlake1'
      ia_ij(k)    = ia_src
      scale_ij(k) = 1.
...
c     
      k=k+1
      ij_tlake2top = k
      lname_ij(k) = 'Second Layer Lake Temperature, Top'
      units_ij(k) = 'C'
      name_ij(k)  = 'tlake2top'
      ia_ij(k)    = ia_src
      scale_ij(k) = 1.
...
c     
      k=k+1
      ij_tlake2mean = k
      lname_ij(k) = 'Second Layer Lake Temperature, Mean'
      units_ij(k) = 'C'
      name_ij(k)  = 'tlake2mean'
      ia_ij(k)    = ia_src
      scale_ij(k) = 1.
      denom_ij(k) = IJ_LK
c     
      k=k+1
      ij_tlake2bot = k
      lname_ij(k) = 'Second Layer Lake Temperature, Bottom'
      units_ij(k) = 'C'
      name_ij(k)  = 'tlake2bot'
      ia_ij(k)    = ia_src
      scale_ij(k) = 1.
...
c
      k=k+1
      IJ_GML = k
      lname_ij(k) = 'ENTHALPY OF LAKE AND RIVER WATER/grid cell area'
      units_ij(k) = '10^5 J/m2'
      name_ij(k) = 'gml'
      ia_ij(k) = ia_src
      scale_ij(k) = 1.d-5
      !ir_ij(k) = ir_m1_3
...
c
      k=k+1
      IJ_RiverSpeed = k
      lname_ij(k) = 'River Speed'
      units_ij(k) = 'm/s'
      name_ij(k)  = 'RiverSpeed'
      ia_ij(k)    = ia_src
      scale_ij(k) = 1.
c
      k=k+1 !
...
c
      k=k+1 !
      IJ_IMPMGR = k ! IMPLICIT MASS FLUX over GROUND (kg/m^2/s)           1 SF
...
c
      k=k+1 !
      IJ_IMPMKI = k ! IMPLICIT MASS FLUX over LAKE ICE (kg/m^2/s)           1 SF
...
c
      k=k+1 !
      IJ_GEOtherm = k ! geothermal heat flux into lowest soil level EA
      lname_ij(k) = 'GEOTHERMAL HEAT FLUX INTO LOWEST SOIL LEVEL/LAKE'
      units_ij(k) = 'W/m^2'
      name_ij(k) = 'e_geotherm'
      ia_ij(k) = ia_src
      scale_ij(k) = 1.d0
      ir_ij(k) = ir_m1_3
      denom_ij(k) = IJ_PLAND
      call sync_param("ngrids",ngrids)
      if(ngrids==1) denom_ij(k) = 0
c
      K = K+1
...
c
      k=k+1 !
      IJ_SRVISSURF = k ! SRVISSURF*COSZ (W/m**2)              2 RD
...
c
      k=k+1 !
      IJ_SRVDIR = k ! FSRDIR*SRVISSURF*COSZ (W/m**2)          2 RD
...
c
          ...
          scale_ij(k)=1.
          ia_ij(k) = ia_rad_frc
          lname_ij(k)='All Sky Aerosol Optical Depth'
c
          k=k+1
          ij_tau_aer_nint2=k        
          name_ij(k)='AOT_AERO2'
...
c
          k=k+1
          ij_tau_aer_nint16=k        
          name_ij(k)='AOT_AERO16'
          units_ij(k)='-'
          scale_ij(k)=1.
          ia_ij(k) = ia_rad_frc
          lname_ij(k)='All Sky Aerosol Optical Depth'
#endif  /* USE_OFFLINE_AEROSOLS */
        endif
c
        k=k+1 !
...
c
      ...
      k=k+1
      IJ_CO2cond = k
      name_ij(k) = 'mass_CO2cond' !
      lname_ij(k) = 'MASS OF CO2 CONDENSATE'
      units_ij(k) = 'kg/m^2'
      ia_ij(k) = ia_srf
      scale_ij(k) = 1.
      denom_ij(k) = IJ_PSOIL
...
c
      k=k+1
      IJ_GMLir = k
      lname_ij(k) = 'ENTHALPY OF LAKE/RIVER LOST TO IRRIG/AREA'
      units_ij(k) = 'J/m2'
...
c
      k=k+1
      IJ_MWLir = k
      lname_ij(k) = 'MASS OF LAKE/RIVER WATER USED FOR IRRIG/AREA'
      units_ij(k) = 'kg/m2/s'
...
c
      ...
      do i = 1, n_band_lw
        k=k+1
        write(band_string, '(I8)') i
        lname_ij(k) = 'OUTGOING THERMAL RADIATION AT TOA, BAND ' //
     &      trim(adjustl(band_string))
        units_ij(k) = 'W/m^2'
        name_ij(k) = 'trup_toa_band_' // trim(adjustl(band_string))
        ia_ij(k) = ia_rad
        ir_ij(k) = ir_0_710
        index1(k) = IJ_TRUPTOA_BND1
        coord3(i, IJ_TRUPTOA_BND1) = i
      end do
      name3(IJ_TRUPTOA_BND1) = 'trup_toa'
      lname3(IJ_TRUPTOA_BND1) = 'OUTGOING THERMAL RADIATION AT TOA'
      dim3name(IJ_TRUPTOA_BND1) = 'band_lw'
      dim3units(IJ_TRUPTOA_BND1) = ''

      IJ_SRUPTOA_BND1 = k+1
      do i = 1, n_band_sw
        k=k+1
        write(band_string, '(I8)') i
        lname_ij(k) = 'OUTGOING SOLAR RADIATION AT TOA, BAND ' //
     &      trim(adjustl(band_string))
        units_ij(k) = 'W/m^2'
        name_ij(k) = 'srup_toa_band_' // trim(adjustl(band_string))
        ia_ij(k) = ia_rad
        ir_ij(k) = ir_0_710
        index1(k) = IJ_SRUPTOA_BND1
        coord3(i, IJ_SRUPTOA_BND1) = i
      end do
      name3(IJ_SRUPTOA_BND1) = 'srup_toa'
      lname3(IJ_SRUPTOA_BND1) = 'OUTGOING SOLAR RADIATION AT TOA'
      dim3name(IJ_SRUPTOA_BND1) = 'band_sw'
      dim3units(IJ_SRUPTOA_BND1) = ''
      ij_sw_diminfo = IJ_SRUPTOA_BND1

      IJ_SRDNTOA_BND1 = k+1
      do i = 1, n_band_sw
        k=k+1
        write(band_string, '(I8)') i
        lname_ij(k) = 'DOWNWELLING SOLAR RADIATION AT TOA, BAND ' //
     &      trim(adjustl(band_string))
        units_ij(k) = 'W/m^2'
        name_ij(k) = 'srdn_toa_band_' // trim(adjustl(band_string))
        ia_ij(k) = ia_rad
        ir_ij(k) = ir_0_710
        index1(k) = IJ_SRDNTOA_BND1
      end do
      name3(IJ_SRDNTOA_BND1) = 'srdn_toa'
      lname3(IJ_SRDNTOA_BND1) = 'DOWNWELLING SOLAR RADIATION AT TOA'
      dim3info_index(IJ_SRDNTOA_BND1) = ij_sw_diminfo
#endif
      ...
      k=k+1        ! The Fire Count (no need to save for ubiquitous
        ij_fireCount = k ! case, since it is constant factor times flammability)
      ...
      k=k+1
        ...
        k = k+1
        ij_frac_for = k 
        lname_ij(k) = 'fraction that is forests (DRY DEP)'
        name_ij(k) = 'frac_for'
        units_ij(k)='fractional'
        scale_ij(k)=1.d0

        k = k+1
        ij_frac_cro = k
        lname_ij(k) = 'fraction that is crops (DRY DEP)'
        name_ij(k) = 'frac_cro'
        units_ij(k)='fractional'
        scale_ij(k)=1.d0
        ...
        k = k+1
        ij_frac_gra = k
        lname_ij(k) = 'fraction that is grass (DRY DEP)'
        name_ij(k) = 'frac_gra'
        units_ij(k)='fractional'
        scale_ij(k)=1.d0
        ...
        k = k+1
        ij_frac_shr = k
        lname_ij(k) = 'fraction that is shrubs (DRY DEP)'
        name_ij(k) = 'frac_shr'
        units_ij(k)='fractional'
        scale_ij(k)=1.d0
        ...
        k = k+1
        ij_frac_bar = k
        lname_ij(k) = 'fraction that is bare (DRY DEP)'
        name_ij(k) = 'frac_bar'
        units_ij(k)='fractional'
        scale_ij(k)=1.d0
#endif
...
c
      ...
      ij_fland = k
      name_ij(k) = 'frac_land'
      lname_ij(k) = 'LAND COVERAGE, excl. LAKES, incl. LAND ICE'
      units_ij(k) = '%'
      scale_ij(k) = 100.
...
C****
      ...
      if (AM_I_ROOT()) then
         ...
         write (6,*) 'Number of AIJ diagnostics: KAIJ,Kused=',KAIJ,K
         if(qcheck) then
           do kk=1,k
...
c
      ...
      IJL_cldwtr   = k
      name_ijl(k)  = 'wtrcld'
      lname_ijl(k) = 'Stratiform Cloud Liquid Water Mass Mixing Ratio'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP
      ia_ijl(k)    = ia_src
...
c
      ...
      IJL_cldice   = k
      name_ijl(k)  = 'icecld'
      lname_ijl(k) = 'Stratiform Cloud Ice Water Mass Mixing Ratio'
      units_ijl(k) = 'kg/kg'
      scale_ijl(k) = 1.
      denom_ijl(k) = IJL_DP
      ia_ijl(k)    = ia_src
...
c
      ...
      ijl_wcf = k
      name_ijl(k)  = 'wcf'
      lname_ijl(k) = 'WATER CLOUD FRACTION (conv+strat)'
      units_ijl(k) = '-'
      ia_ijl(k)    = ia_rad
c
      k=k+1
      ijl_icf = k
      name_ijl(k)  = 'icf'
      lname_ijl(k) = 'ICE CLOUD FRACTION (conv+strat)'
      units_ijl(k) = '-'
      ia_ijl(k)    = ia_rad
c
      k=k+1
      ijl_wcmmr = k
      name_ijl(k)  = 'wcmmr'
      lname_ijl(k) = 'Liquid Water Mass Mixing Ratio (conv+strat)' ! unweighted gridbox-mean, cloud+in-cloud precip
      units_ijl(k) = 'kg/kg'
      ia_ijl(k)    = ia_rad
c
      k=k+1
      ijl_icmmr = k
      name_ijl(k)  = 'icmmr'
      lname_ijl(k) = 'Ice Water Mass Mixing Ratio (conv+strat)' ! unweighted gridbox-mean, cloud+in-cloud precip
      units_ijl(k) = 'kg/kg'
      ia_ijl(k)    = ia_rad
c
      k=k+1
      ijl_wcsiz = k
      denom_ijl(k) = ijl_wcmmr
      name_ijl(k)  = 'wcsiz'
      lname_ijl(k) =
     &  'LIQUID PARTICLE EFFECTIVE RADIUS (conv+strat)' ! weighted by liquid water mixing ratio
      units_ijl(k) = 'micron'
      ia_ijl(k)    = ia_rad
c
      k=k+1
      ijl_icsiz = k
      denom_ijl(k) = ijl_icmmr
      name_ijl(k)  = 'icsiz'
      lname_ijl(k) =
     &  'ICE PARTICLE EFFECTIVE RADIUS (conv+strat)' ! weighted by ice water mixing ratio
      units_ijl(k) = 'micron'
      ia_ijl(k)    = ia_rad
c
#else /* not MORE_CLOUD_DIAGS_3D */
c
      k=k+1        ! mass fraction of conv+strat cloud+in-cloud precip liquid seen by radiation
      IJL_QLrad    = k
      name_ijl(k)  = 'QLrad'
      ...
      lgrid_ijl(k) = ctr_ml
c
      k=k+1        ! mass fraction of conv+strat cloud+in-cloud precip ice seen by radiation
      IJL_QIrad    = k
      name_ijl(k)  = 'QIrad'
