...
!@dbparam fkph background vertical diffusion coefficient (cm**2/sec)
!@+       (named ocean_fkph in rundecks)
!@dbparam fkpm background vertical viscosity coefficient (cm**2/sec)
!@+       (still assumed to be 10*fkph where fkph is a dbparam)
      real*8 ::
     &    fkph   = 0.1d0
     &  , fkpm   = 10.*0.1d0
...
c      epsl    = epsln
      ...
      call sync_param('ocean_fkph',fkph)

! Still assuming this constant of proportionality even when fkph
! is a rundeck parameter
      fkpm   = 10d0*fkph
