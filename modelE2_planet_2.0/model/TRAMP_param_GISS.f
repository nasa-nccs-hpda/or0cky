...
!-------------------------------------------------------------------------------------------------------------------------
      ...
      INTEGER, PARAMETER :: NEMIS_SPCS        =  2 ! number of emissions variables for mechanism 11
#else
      ...
      INTEGER, PARAMETER :: INUC              =  2 ! =1 JVM  Select the nucleation scheme
                                                   ! =2 VEHKAMAKI  Select the nucleation scheme
                                                   ! =3 NAPARI  Select the nucleation scheme
                                                   ! =4 EISELE AND EISELE AND MCMURRY, 1997   Select the nucleation scheme
                                                   ! =5 YU   Select the nucleation scheme
...
!-------------------------------------------------------------------------------------------------------------------------
      INTEGER, SAVE :: MASS_NO3, MASS_NH4, MASS_H2O 
