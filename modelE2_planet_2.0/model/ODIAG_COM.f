...
!@auth Gary Russell/Gavin Schmidt
      ...
      IMPLICIT NONE
      SAVE
      INTEGER, PARAMETER :: KOIJ=72,KOL=6,KOLNST=14,KOIJmm=11
...
c
      K = K+1
      IJ_dEPO_Geoth = K  !  OCEANS
      LNAME_OIJ(K) = 'Geothermal Heat Flux into lowest ocean layer'
      SNAME_OIJ(K) = 'dEPO_Geoth'    
      UNITS_OIJ(K) = 'W/m^2'
      SCALE_OIJ(K) = 1
      denom_oij(k) = IJ_OCNFR
c
