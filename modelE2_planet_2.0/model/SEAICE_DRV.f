...
#if (defined TRACERS_GASEXCH_ocean) || (defined TRACERS_GASEXCH_land) || (defined TRACERS_GASEXCH_GCC)
#ifdef TRACERS_WATER
...
!@calls seaice:addice
      ...
      REAL*8 POICE,PWATER,FLEAD,POCEAN,DMIMP,DHIMP,DSIMP
#ifdef TRACERS_WATER
      REAL*8, DIMENSION(NTM,LMI) :: trsil
...
C**** save implicit mass-flux diagnostics
     ...
     &                -DHIMP *POICE)
      ...
      if (TSIL(1).lt.minIceTemperature) then
         write(6,*) "Seaice: T <",minIceTemperature,
     *           "i,j,TSI = ",i,j,TSIL(1:LMI)
...
C**** Set minimal tolerated sea ice temperature
      call sync_param( "minIceTemperature", minIceTemperature)
