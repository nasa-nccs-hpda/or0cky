...
!         CALL BROWNIAN_COAG_COEF( DI, DJ, TEMPL, PRESL, 0.0, BETAIJ ) ! all variables single precision
          CALL TOTAL_COAG_COEF   ( DI, DJ, TEMPL, PRESL, 0.0, BETAIJ ) ! all variables single precision
