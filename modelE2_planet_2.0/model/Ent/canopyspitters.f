...
!          endif  !NK DEBUG
     ...
     &         ,pp%albedo(1)
     &         ,pp%LAI
     &         ,cop%LAI,IPAR*SWtoPAR !4.05 see canopyfluxes comments.
     &         ,CosZen,fdir
     &         ,Gb
     &         ,psdrvpar
...
!     &       ,if_ci)  
          ...
          ent_d%fdry_pft_eff(cop%pft) = ent_d%fdry_pft_eff(cop%pft) +
     &        fdry_pft_eff * 1.d0/(3600*24*1000.d0) ! scaling hack
...
! Shortwave penetrating sunlit foliage (umol/m[foliage]2/s).
        ...
        !abssh=0.001D0
        abssh=(1.0D0-rhor)*kdf*exp(-kdf*alai)
        abssl=0.0D0
        fracsl=0
      endif
