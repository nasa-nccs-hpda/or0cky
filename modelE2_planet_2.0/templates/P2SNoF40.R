...
P2SNoF40: ROCKE-3D, based on ModelE 2.1 with very minor updates and fixes
...
#include "rad_input_files_planet_socrates"

MSU_wts=MSU_SSU_RSS_weights.txt      ! MSU-diag
REG=REG2X2.5                      ! special regions-diag

Label and Namelist:  (next 2 lines)
P2SNoF40 (ROCKE-3D, based on P2SNoF40 template)

&&PARAMETERS
#include "dynamic_ocn_params_planet"
#include "sdragF40_params"

#include "socrates_input_files"
...
U00b=0.50   ! below 850mb and MC regions; tune this last  to get rad.balance
WMU_multiplier = 1.
