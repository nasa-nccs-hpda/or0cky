...
P2SxoF40: ROCKE-3D, based on ModelE 2.1 with very minor updates and fixes
  P2: planet_2.0 model version
  S: SOCRATES radiation
  x: atmospheric composition for Earth, year 1850, without aerosols, O3,
...
P2SxoF40 (ROCKE-3D, based on P2SxoF40 template)
