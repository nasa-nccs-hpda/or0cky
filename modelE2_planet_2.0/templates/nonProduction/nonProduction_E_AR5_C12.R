E6C12.R GISS Model E Tom Clune 02/28/2011

E6C12 is a coarse resolution of E6F40.
...
!XXX add the model top in the comment #define ATM_LAYERING L12         ! 12 layers, top at .1 mb
...
E6C12 (ModelE 8x10, 12 layers, 1850 atm, 1950 prescr. ocn)
...
U00a=0.665  ! above 850mb w/o MC region;  tune this first to get 30-35% high clouds
U00b=1.00   ! below 850mb and MC regions; tune this last  to get rad.balance
WMUI_multiplier = 2.
use_vmp=1
radius_multiplier=1.1

!XXX is this different for a reason? PTLISO=15.       ! press(mb) above which rad. assumes isothermal layers
...
NIsurf=1         ! surface interaction computed NIsurf times per source time step
