...
P2SxqM40: ROCKE-3D, based on ModelE 2.1 with very minor updates and fixes
...
P2SxqM40 (ROCKE-3D, based on P2SxqM40 template)
...
U00b=0.538  ! below 850mb and MC regions; tune this last  to get rad.balance
WMU_multiplier = 1.
