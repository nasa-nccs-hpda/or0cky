LP002RSM40.R  ROCKE-3D planet branch. M40    N.Y.Kiang 6/1/2018, M. Kelley 7/2013, R.Ruedy 10/2018

LP002RSM40: same as LP002SM40 but using LAKESR instead of LAKES/RIVERF
...
#include "planet_source_files_LAKESR"
...
Label and Namelist:
LP002RSM40 (LP002.M8.2V.S0X1.1.OBL28.ROT72.Pmb1916.CO2log10f-2.H2Om0.41.Sa)
...
RIVER_FAC=4.0 ! tuning factor to multiply lakes runoff
lake_ice_max=1.d30
wsn_max=1.d30
