P1SoM40.R GISS Model E  coupled version          larissa   01/22/2009

P1SoM40: 4x5x40 layers modelE version, 1880 atm.; 13 layers in the ocean

P1SoM40: replace this section by a description of what distinguishes this run ?
...
modelE1 (3.0) 4x5 hor. grid with 40 lyrs, top at .1 mb (+ 3 rad.lyrs)       ?
...
Label and Namelist:
P1SoM40 (1880 atm.,the current modelE version)
...
! Tuning parameters as of 2016/10/28 with prescribed SST (D.S. Amundsen)
...
! Orbit parameters that have different defaults for Earth and not-Earth
! EOT = 'F' for Earth
! EOT = 'T' for not-Earth
