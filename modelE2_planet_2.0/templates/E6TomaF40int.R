...
#define DYNAMIC_BIOMASS_BURNING  ! alter biomass burning emissions by pyrE
...
#define CACHED_SUBDD
#define SOLAR_ENERGETIC_PARTICLES ! solar protons affect Shindell chemistry
#define EESC_BASED_CLTOT_BRTOT ! Shindell chemistry alternate Cl/Br treatment
...
ION_PAIRS=giss2/iprX_CMIP_SOLARIS-HEPPA-3-2
IGRF_COEFFS=giss2/igrf_ceofs_c160412.nc
EESC=giss2/eesc_timestream ! Equivalent Effective Stratospheric Chlorine
#include "chemistry_144x90_input_files"
#include "dust_tracer_144x90_input_files"
#include "chem_emiss_144x90_input_files_CMIP6_noBBURN_yesAcetone"
...
ns_wet=10       ! index of CH4 source that is the wetlands (will be altered online)
