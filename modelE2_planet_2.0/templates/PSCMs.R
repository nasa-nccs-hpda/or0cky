PSCMs.R GISS Model E      M. Kelley 10/2013
                          A. Wolf Planet branch 9/2017

Run SCM using GCM IC's and no advective forcings and socrates rad

!! P4qsM20: P4SM40 with 65m q-flux ocean ("!!"-lines are for P4qsM20.R)
P4SM40SMP: modelE as frozen in July 2009 without gravity wave drag
...
!O3file=/path/to/user/directory/extractions/o3_2005_shindelltrop_72x46x49_1850-1997_ple.nc
...
OCNML=/path/to/user/directory/extractions/Z1O.B4X5.cor.nc   ! mixed layer depth (needed for post processing)
...
!CO2profile=CO2profile.Feb2017.txt ! scaling of CO2 in stratosphere
!CO2profile=CO2profile.Jan2017.txt ! original 40-layer version
!dH2O=dH2O_by_CH4_monthly
MSU_wts=MSU_SSU_RSS_weights.txt

Label and Namelist:
PSCMs (Run SCM Planetary Master Free-Running GCM ICs Socrates radiation)


&&PARAMETERS

! SCM parameters
                           ! test location land surface
