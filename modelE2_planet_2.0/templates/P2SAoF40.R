...
P2SAoF40: ROCKE-3D, based on ModelE 2.1 with very minor updates and fixes
...
Uses turbulence scheme, gravity wave drag
...
#include "dynamic_ocn_288x180_input_files_CMIP6"
RVR=RD_Fd.nc             ! river direction file
NAMERVR=RD_Fd.names.txt  ! named river outlets

#include "land144x90_input_files"
#include "rad_input_files_socrates"
#include "planet_rad_144x90_input_files"

MSU_wts=MSU_SSU_RSS_weights.txt      ! MSU-diag
REG=REG2X2.5                      ! special regions-diag

Label and Namelist:  (next 2 lines)
P2SAoF40 (ROCKE-3D, based on P2SAoF40 template)

&&PARAMETERS
#include "dynamic_ocn_params_CMIP6"
#include "sdragF40_params"
#include "gwdragF40_params"

#include "socrates_input_files_aer"
...
U00a=0.7    ! above 850mb w/o MC region;  tune this first to get 30-35% high clouds
