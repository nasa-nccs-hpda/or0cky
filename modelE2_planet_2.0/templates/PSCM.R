PSCM.R GISS Model E      M. Kelley 10/2013
                         A. Wolf Planet branch 9/2017

Run SCM using GCM IC's and no advective forcings

From P4M40.R
P4M40SMP: modelE as frozen in July 2009 without gravity wave drag
...
! SCM input files
SCM_NML=SCM_ARM.nml       ! input variable namelist with units  (dummy if no SCM input forcing data)
...
Label and Namelist:
PSCM (Run SCM Planetary Master Free-Running GCM ICs)
...
SCM_sfc=-1                 ! -1:GCM IC's land only 
