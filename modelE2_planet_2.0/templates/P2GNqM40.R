...
P2GNqM40: ROCKE-3D, based on ModelE 2.1 with very minor updates and fixes
...
P2GNqM40 (ROCKE-3D, based on P2GNqM40 template)
...
U00a=0.6    ! above 850mb w/o MC region;  tune this first to get 30-35% high clouds
