E6TomaMinF40clim2000.R GISS ModelE Lat-Lon Atmosphere Model, climatological ocn/atm OMA tracers with multiple dust minerals

E6TomaMinF40clim2000: E6TomaF40clim2000 but with multiple dust mineral species
...
#define MINDUS_RADSW             ! mineral dependent radiative properties of dust
#define EXTMIX_MINERALS          ! externally mixed minerals, iron oxide internally mixed
! #define INTMIX_MINERALS        ! alternative: all internally mixed
...
#include "mineralrad_input_files"
...
E6TomaMinF40clim2000 (climatological prescribed ocean atmospheric tracer model with OMA with multiple dust minerals and Shindell chemistry)
