...
WARNING: NON-PRODUCTION VERSION. I.E.:
  This was just copied from E2.1 and altered to allow compilation but not
    checked that all settings make sense on this branch.
...
#include "chem_emiss_144x90_input_files_SSP585_Acetone"
...
#include "dust_params_vmp_oma_triell"
#include "lightning_fire_params"
#include "chemistry_params_CMIP6"
#include "ch4_params_with_emissions_CMIP6_SSP"

! The lines default_itime_tr0, any exceptions, and allowSomeChemReinit may be needed 
! in some cases (like ISTART=8 starts) to prevent tracers reinitialization:

! Default itime_tr0 for all tracers (not specifying a default sets it to itime at the start):
!  default_itime_tr0=-1
! Exceptions to default itime_tr0 listed below (format: <tracer>_itime_tr0=<integer>):
