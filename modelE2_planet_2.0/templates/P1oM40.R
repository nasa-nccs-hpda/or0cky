P1oM40.R GISS Model E  coupled version          larissa   01/22/2009

P1oM40: 4x5x40 layers modelE version, 1880 atm.; 13 layers in the ocean

P1oM40: replace this section by a description of what distinguishes this run ?
...
Label and Namelist:
P1oM40 (1880 atm.,the current modelE version)
