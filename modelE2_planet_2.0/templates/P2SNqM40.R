...
P2SNqM40: ROCKE-3D, based on ModelE 2.1 with very minor updates and fixes
  ...
  q: zero Q-flux ocean, 100 m depth
...
#include "qflux_ocn_1880_72x46_planet_input_files"
RVR=RD_modelE_M.nc                ! river direction file
NAMERVR=RD_modelE_M.names.txt     ! named river outlets

#include "land72x46_planet_input_files_nocrops"
...
P2SNqM40 (ROCKE-3D, based on P2SNqM40 template)

&&PARAMETERS
#include "qflux_ocn_params"
...
U00a=0.67   ! above 850mb w/o MC region;  tune this first to get 30-35% high clouds
